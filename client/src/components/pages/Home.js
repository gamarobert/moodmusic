  ...
  return (
    <div className="home-grid ">
      <div className="grid-about text-center">
        <h1>What is this?</h1>
        <p>
          <i>moodmusic</i> is a web application created with ReactJS.
          <i>moodmusic</i> aims to curate tracks depending on the users mood and
          genre preference using the Spotify Web API.
        </p>
      </div>
